...
Prior to building the `filebrowser.s9pk` package, it's essential to configure your build environment for StartOS services. You can find instructions on how to set up the appropriate build environment in the [Packaging Guide](https://staging.docs.start9.com/packaging-guide/).
...
**Tip:** You can also install the filebrowser.s9pk by sideloading it under the **StartOS > Sideload a Service** section.
